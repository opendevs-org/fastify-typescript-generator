...
const downloadNodeModules = (config, destination) => {
	...
	console.log('\x1b[31m\x1b[40m%s\x1b[0m', `Installing dependencies ${config.dependencies}...\n`);
	execSync('npm i ' + config.dependencies, options);
	console.log('\x1b[32m\x1b[40m%s\x1b[0m', 'Dependencies installation done...\n');
	console.log('\x1b[31m\x1b[40m%s\x1b[0m', `Installing dev dependencies  ${ config.devDependencies}...\n`);
